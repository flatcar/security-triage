...
def wrapper() -> int:
    parser = argparse.ArgumentParser(description="Run fixture-backed discovery dry run")
    parser.add_argument("--source-fixture", default=str(ROOT / "tests/fixtures/discovery_entries.json"))
    ...
    parser.add_argument("--output", default=str(ROOT / "reports/discovery-dry-run.md"), help="Markdown output path")
